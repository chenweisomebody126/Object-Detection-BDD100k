...
labels = [
    ...
    Label(  'person'               , 31 ,       4 , 'human'           , 6       , True         , False        , (220, 20, 60) ),
    Label(  'rider'                , 32 ,       5 , 'human'           , 6       , True         , False        , (255,  0,  0) ),
    Label(  'bike'              , 33 ,       0 , 'vehicle'         , 7       , True         , False        , (119, 11, 32) ),
    Label(  'bus'                  , 34 ,       1 , 'vehicle'         , 7       , True         , False        , (  0, 60,100) ),
    Label(  'car'                  , 35 ,       2 , 'vehicle'         , 7       , True         , False        , (  0,  0,142) ),
    # Label(  'caravan'              , 36 ,      255 , 'vehicle'         , 7       , True         , True         , (  0,  0, 90) ),
    Label(  'motor'           , 37 ,       3 , 'vehicle'         , 7       , True         , False        , (  0,  0,230) ),
    # Label(  'trailer'              , 38 ,      255 , 'vehicle'         , 7       , True         , True         , (  0,  0,110) ),
    Label(  'train'                , 39 ,       8 , 'vehicle'         , 7       , True         , False        , (  0, 80,100) ),
    Label(  'truck'                , 40 ,       9 , 'vehicle'         , 7       , True         , False        , (  0,  0, 70) ),
]
